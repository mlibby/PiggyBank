# Install and manage PiggyBank as a Windows service
#
# To run the service, you must install it first.
#
# Usage: ruby piggybank_win32.rb <option>
#
# Options:
#    install    - Installs the service.  The service name is "PiggyBankSvc"
#                 and the display name is "PiggyBank".
...
SERVICE_NAME = 'PiggyBankSvc'
SERVICE_DISPLAYNAME = 'PiggyBank'
...
case ARGV[0].downcase
   when 'install'
      Service.new(
         ...
         :description      => 'PiggyBank Web Service',
