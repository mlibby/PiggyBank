<template>
    <main>
        <div>
            ...
            <p>
                You may enter an "extra" principal payment that will be applied to every
                payment. You may also enter lump sum extra principal payments once you
                have generated the amortization table. You can apply both kinds of extra
                principal payments.
            </p>
        </div>
        <div class="columns">
