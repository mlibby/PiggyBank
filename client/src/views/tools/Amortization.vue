<template>
    <main>
        <div>
            ...
            <p>
                You may enter an "extra" principal payment that
                will be applied to every payment. You may also
                enter lump sum extra principal payments once you
                have generated the amortization table. You can
                apply both kinds of extra principal payments.
            </p>
        </div>
        <div class="columns">
            <div class="column column-1-4">
                <section>
                    ...
                    <form v-on:submit="calculate">
                        ...
                        />
                        <spinner-button :onClick="calculate"
        ...
        calculate(next) {
            ...
            axios
                ...
                .then((response) => {
                    ...
                    this.payment_amount = formatCurrency(
                        data.payment_amount
                    );
                    this.payments = data.payments;
                    this.total_interest = formatCurrency(
                        data.total_interest
                    );
                    let saved_interest =
                        data.original_interest -
                        data.total_interest;
                    this.saved_interest =
                        formatCurrency(saved_interest);
