...
{
    private static Dictionary<string, Account.AccountType> GnuCashToPiggyBank = new Dictionary<string, Account.AccountType>
    {
    ...
    public Account.AccountType PiggyBankAccountType
    {
        get
        {
